...
exports.BattleAbilities = {
	...
	"zenmode": {
		...
		onStart: function(pokemon) {
			if (pokemon.template.speciesid==='darmanitan' && pokemon.formeChange('Darmanitan-Zen')) {
				pokemon.transformed = false;
	...
	"eternalfrost": {
		desc: "When this Pokemon enters battle, a Snowstorm will be summoned.",
		shortDesc: "Summons a Snowstorm.",
		onStart: function (source) {
